...
int y = 0;
	...
	{		
		...
		(*lista_colectivos)[i]->Subir_Personas();
...
void cSistema_Rutatlantica::cant_Personas()
{
	for (int i = 0; i <= lista_colectivos->getCA(); i++)
	{
		cout << "Cantidad de personas que se subieron: " << (*lista_colectivos)[i]->getCantidad_de_Personas() << endl;
	}
}
...
void cSistema_Rutatlantica::monto_porColectivo()
{
	for (int i = 0; i <= lista_colectivos->getCA(); i++)
	{
		cout << "Cantidad de Dinero recaudado en el colectivo: " << (*lista_colectivos)[i]->Cobrar_Boleto() << endl;
	}
}
...
void cSistema_Rutatlantica::Listar()
{
	cout << "Lista de colectivos: \n" << endl;

	for (int i = 0; i <= lista_colectivos->getCA(); i++)
	{
		/*cout << "\nColectivo: " << (*lista_colectivos)[i]->getCodigo_Colectivo() << "\tRamal: " << (*lista_colectivos)[i]->getRamal() << "\nCantidad de personas que se trasladaron en el colectivo: " << endl; << cant_Personas() << "\tCantidad de dinero recaudado en dicho colectivo: " << monto_porColectivo() << endl;
		cant_Personas();
		cout << "\tCantidad de dinero recaudado en dicho colectivo: " << endl;
		monto_porColectivo();*/

		cout << "\n%d) Codigo del Colectivo: " << i << (*lista_colectivos)[i]->getCodigo_Colectivo() << "\tRamal: " << (*lista_colectivos)[i]->getRamal() << "\nCantidad de personas que se trasladaron en el colectivo: " << (*lista_colectivos)[i]->getCantidad_de_Personas() << "\tCantidad de dinero recaudado en dicho colectivo: " << (*lista_colectivos)[i]->Cobrar_Boleto() << endl;
	}

	cout << "\nCantidad total de Personas que viajaron en colectivo: " << total_cant_Personas();
	cout << "\nCantidad total recaudado por todos los colectivos: " << total_cant_monto();
}
